...
@Profile("!test")
public class BookerlandSecurityConfiguration extends WebSecurityConfigurerAdapter implements WebMvcConfigurer {
    ...
    AuthenticationProvider authenticationProvider() {
        ...
        BookerlandUserDetailsService detailsService = new BookerlandUserDetailsService(userEntityRepository, config);
